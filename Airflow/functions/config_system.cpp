...
namespace config
{
  ...
  void create( const std::string& config_name )
  {
    ...
    auto& rage = json_obj [ xor_c( "rage" ) ];
    {
      ...
      save_bool( rage, xor_c( "delay_unduck" ), default_config.rage.delay_unduck );
      save_int( rage, xor_c( "auto_baim_misses" ), default_config.rage.auto_baim_misses );
      save_int( rage, xor_c( "fakelag_correction" ), default_config.rage.fakelag_correction );
    ...
    auto& antihit = json_obj [ xor_c( "antihit" ) ];
    {
      ...
      save_int( antihit, xor_c( "fake_type" ), default_config.antihit.fake_type );
      save_int( antihit, xor_c( "fake_spin_speed" ), default_config.antihit.fake_spin_speed );
      save_int( antihit, xor_c( "fake_jitter_min" ), default_config.antihit.fake_jitter_min );
      save_int( antihit, xor_c( "fake_jitter_max" ), default_config.antihit.fake_jitter_max );
      save_int( antihit, xor_c( "freestanding_mode" ), default_config.antihit.freestanding_mode );

      save_bool( antihit, xor_c( "fakelag" ), default_config.antihit.fakelag );
      save_bool( antihit, xor_c( "fakelag_break_lc" ), default_config.antihit.fakelag_break_lc );
      save_bool( antihit, xor_c( "fakelag_jitter" ), default_config.antihit.fakelag_jitter );
  ...
  void save( const std::string& config_name )
  {
    ...
    auto& rage = json_obj [ xor_c( "rage" ) ];
    {
      ...
      save_bool( rage, xor_c( "delay_unduck" ), g_cfg.rage.delay_unduck );
      save_int( rage, xor_c( "auto_baim_misses" ), g_cfg.rage.auto_baim_misses );
      save_int( rage, xor_c( "fakelag_correction" ), g_cfg.rage.fakelag_correction );
    ...
    auto& antihit = json_obj [ xor_c( "antihit" ) ];
    {
      ...
      save_int( antihit, xor_c( "fake_type" ), g_cfg.antihit.fake_type );
      save_int( antihit, xor_c( "fake_spin_speed" ), g_cfg.antihit.fake_spin_speed );
      save_int( antihit, xor_c( "fake_jitter_min" ), g_cfg.antihit.fake_jitter_min );
      save_int( antihit, xor_c( "fake_jitter_max" ), g_cfg.antihit.fake_jitter_max );
      save_int( antihit, xor_c( "freestanding_mode" ), g_cfg.antihit.freestanding_mode );

      save_bool( antihit, xor_c( "fakelag" ), g_cfg.antihit.fakelag );
      save_bool( antihit, xor_c( "fakelag_break_lc" ), g_cfg.antihit.fakelag_break_lc );
      save_bool( antihit, xor_c( "fakelag_jitter" ), g_cfg.antihit.fakelag_jitter );
  ...
  void load( const std::string& config_name )
  {
    ...
    auto& rage = json_obj [ xor_c( "rage" ) ];
    {
      ...
      load_bool( rage, xor_c( "delay_unduck" ), g_cfg.rage.delay_unduck );
      load_int( rage, xor_c( "auto_baim_misses" ), g_cfg.rage.auto_baim_misses );
      load_int( rage, xor_c( "fakelag_correction" ), g_cfg.rage.fakelag_correction );
    ...
    auto& antihit = json_obj [ xor_c( "antihit" ) ];
    {
      ...
      load_int( antihit, xor_c( "fake_type" ), g_cfg.antihit.fake_type );
      load_int( antihit, xor_c( "fake_spin_speed" ), g_cfg.antihit.fake_spin_speed );
      load_int( antihit, xor_c( "fake_jitter_min" ), g_cfg.antihit.fake_jitter_min );
      load_int( antihit, xor_c( "fake_jitter_max" ), g_cfg.antihit.fake_jitter_max );
      load_int( antihit, xor_c( "freestanding_mode" ), g_cfg.antihit.freestanding_mode );

      load_bool( antihit, xor_c( "fakelag" ), g_cfg.antihit.fakelag );
      load_bool( antihit, xor_c( "fakelag_break_lc" ), g_cfg.antihit.fakelag_break_lc );
      load_bool( antihit, xor_c( "fakelag_jitter" ), g_cfg.antihit.fakelag_jitter );
